...
HSHM_INDIRECTLY_CALLABLE static HSHM_GPU_FUN void RunImpl(
  ...
  switch (method) {
    case Method::kRegisterTarget:
      self->RegisterTarget(task_ptr.template Cast<RegisterTargetTask>(), rctx);
      break;
    case Method::kGetOrCreateTag:
      self->GetOrCreateTag(task_ptr.template Cast<core::GetOrCreateTagTask<core::CreateParams>>(), rctx);
      break;
    case Method::kPutBlob:
      self->PutBlob(task_ptr.template Cast<PutBlobTask>(), rctx);
      break;
    case Method::kGetBlob:
      self->GetBlob(task_ptr.template Cast<GetBlobTask>(), rctx);
      break;
    default: break;
  }
}
